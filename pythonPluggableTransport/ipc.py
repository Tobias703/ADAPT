# Pluggable Transport IPC protocol (PT spec 3.0 / Tor PT spec 1.0)

# All communication to the parent process goes through newline-terminated lines written to stdout.
# Stderr is for human-readable logging only.

# Grammar (from 1.0 spec):
